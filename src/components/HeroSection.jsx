  ...
  return (
    ...
    >
      <div className='mx-auto flex max-w-6xl flex-col justify-between pt-36 pb-10 md:flex-row md:items-center'>
        <h1
          className='mobile:text-5xl text-4xl leading-[60px] font-bold text-white md:text-6xl
            md:leading-[72px]'
        >
          THE <br /> SHOE <br /> COMPANY
        </h1>
        <div>
          <img className='w-full max-w-xl' src={HeroImage} alt='whit shoe image' loading='lazy' />
        </div>
      </div>
    </section>
  )
